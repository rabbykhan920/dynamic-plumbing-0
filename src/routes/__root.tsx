...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Dynamic Plumbing" },
      { name: "description", content: "Dynamic Plumbing — plumbing without limits." },
      { name: "author", content: "Dynamic Plumbing" },
      { property: "og:title", content: "Dynamic Plumbing" },
